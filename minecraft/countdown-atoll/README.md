...
> `public/downloads/` (`countdown-atoll-datapack-v2.zip`, `-resourcepack.zip`).
...
3. `countdown-atoll-datapack-v2.zip` ins Fenster ziehen → es erscheint links →
...
2. `countdown-atoll-resourcepack-v2.zip` hineinlegen, links auf die rechte Seite
   schieben, **Fertig**.
