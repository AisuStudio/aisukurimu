...
> `public/downloads/` (`countdown-atoll-datapack-v3.zip`, `-resourcepack.zip`).
...
3. `countdown-atoll-datapack-v3.zip` ins Fenster ziehen → es erscheint links →
...
2. `countdown-atoll-resourcepack-v3.zip` hineinlegen, links auf die rechte Seite
   schieben, **Fertig**.
