# Kurze Spielanleitung im Chat
tellraw @a {"text":"— So wird gespielt —","bold":true,"color":"aqua"}
tellraw @a {"text":"1. Waehle oben eine Route. Der Countdown startet (Leiste oben).","color":"gray"}
